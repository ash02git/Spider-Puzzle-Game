...
public class OuterGap : MonoBehaviour
{
    Vector3 pos1;
    Vector3 pos2;
    Vector3 pos3;
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0) && hasClicked == false)//updated here
        {
            ...
            if (GetComponent<Collider2D>() == Physics2D.OverlapPoint(mousepos))
            {
                ...
                if(hasClicked && startedMoving)
                {
                    ...
                    collidedObjects[3].transform.position = Vector3.MoveTowards(collidedObjects[3].transform.position, pos1, speed);
                    
                    
                    if( collidedObjects[0].transform.position == pos2 && collidedObjects[1].transform.position == pos3 && collidedObjects[2].transform.position == pos4 && collidedObjects[3].transform.position == pos1)
                    {
                    startedMoving = false;
                    hasClicked = false;
